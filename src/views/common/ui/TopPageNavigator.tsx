...
export function NavigatorBox( {children}: NavigatorBoxProps ) {
    return (
        <nav className="z-10 ml-[5px] h-[44px] lg:h-[60px] flex gap-[8px] lg:gap-[16px] font-medium text-[20px] leading-[24px] lg:leading-[28px]">
            {children}
        </nav>
    )
}
...
export function ItemLink( {href, children}: ItemLinkProps ) {
    return (
        <Link href={href} className="text-gray-light">
