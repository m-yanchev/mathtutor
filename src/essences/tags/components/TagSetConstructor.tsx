...
import { getTagsFromServer, putTagInServer } from "@/essences/tags/actions";
import TagSet from "./TagSet"
import { Tag } from "@prisma/client";
import TagSelect from "@/essences/tags/ui/TagSelect";
...
function Select({ onAdd, variant = "inExample"}: SelectProps) {
    ...
    return (
        <div className="z-10 flex h-12 gap-4 items-stretch">
